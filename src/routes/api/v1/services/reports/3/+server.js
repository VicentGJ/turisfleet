...
import { carTable, driverTable, groupTable, programTable, requestTable, specificProgramTable } from '$lib/tables'
  ...
  const result = await sequelize
    .transaction(async (t) => {
      let result = await sequelize.query(
       ...
       g.tourist_amount AS "Tourist amount",
...
LEFT JOIN ${driverTable} d ON d.id_driver=c.id_driver
